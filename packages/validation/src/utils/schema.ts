...
export const SCHEMA: Schema<typeof ELEMENTS, typeof SETTINGS> = {
  ...
  elements: [
    ...
    },
    {
      ...
      allowedTypes: ['FormTextInput', 'SearchInput', 'FormCheckboxInput', 'UserFormCheckboxInput'],
      group: SCHEMA_GROUPS.general.key,
      settings: [
    ...
    },
    {
      ...
      allowedTypes: ['Block', 'Link', 'FormButton', 'UserFormButton'],
      group: SCHEMA_GROUPS.general.key,
    },
  ],
};
